...
export const clans: Record<string, ClanConfig> = {
  "pn31": {
    ...
    tag: "PN31",
    name: "Penetration Nation 31",
    cookies: process.env.PN31_COOKIES,
    color: "#0099ff",
    region: "na"
  },
  "pn30": {
    id: parseInt(process.env.PN30_CLAN_ID || "1000094782"), 
    tag: "PN30",
  ...
  "pneu": {
    id: parseInt(process.env.PNEU_CLAN_ID || "1000094716"), 
    tag: "PNEU",
  ...
  "pn32": {
    id: parseInt(process.env.PN32_CLAN_ID || "1000050402"), 
    tag: "PN32",
  ...
  "pn": {
    id: parseInt(process.env.PN_CLAN_ID || "1000064336"), 
    tag: "PN",
